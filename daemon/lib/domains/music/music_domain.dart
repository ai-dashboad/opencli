...
class MusicDomain extends TaskDomain {
  ...
  @override
  String get description => 'Control Music.app playback, playlists, and now playing info';
  @override
  ...
  List<String> get taskTypes => [
    ...
    'music_now_playing', 'music_playlist',
  ];
  ...
  List<DomainOllamaIntent> get ollamaIntents => [
    DomainOllamaIntent(
      ...
      examples: [
        OllamaExample(input: 'play music', intentJson: '{"intent": "music_play", "confidence": 0.95, "parameters": {}}'),
        OllamaExample(input: 'resume playback', intentJson: '{"intent": "music_play", "confidence": 0.95, "parameters": {}}'),
      ],
    ),
    DomainOllamaIntent(
      ...
      examples: [
        OllamaExample(input: 'pause music', intentJson: '{"intent": "music_pause", "confidence": 0.95, "parameters": {}}'),
      ],
    ),
    DomainOllamaIntent(
      ...
      examples: [
        OllamaExample(input: 'play focus playlist', intentJson: '{"intent": "music_playlist", "confidence": 0.95, "parameters": {"playlist": "Focus"}}'),
        OllamaExample(input: 'play lo-fi', intentJson: '{"intent": "music_playlist", "confidence": 0.95, "parameters": {"playlist": "lo-fi"}}'),
      ],
    ),
    DomainOllamaIntent(
      ...
      examples: [
        OllamaExample(input: "what's playing", intentJson: '{"intent": "music_now_playing", "confidence": 0.95, "parameters": {}}'),
      ],
    ),
  ];
  ...
  Map<String, DomainDisplayConfig> get displayConfigs => {
    'music_play': const DomainDisplayConfig(cardType: 'music', titleTemplate: 'Music', icon: 'play_arrow', colorHex: 0xFFE91E63),
    'music_pause': const DomainDisplayConfig(cardType: 'music', titleTemplate: 'Music Paused', icon: 'pause', colorHex: 0xFFE91E63),
    'music_next': const DomainDisplayConfig(cardType: 'music', titleTemplate: 'Next Track', icon: 'skip_next', colorHex: 0xFFE91E63),
    'music_previous': const DomainDisplayConfig(cardType: 'music', titleTemplate: 'Previous Track', icon: 'skip_previous', colorHex: 0xFFE91E63),
    'music_now_playing': const DomainDisplayConfig(cardType: 'music', titleTemplate: 'Now Playing', icon: 'music_note', colorHex: 0xFFE91E63),
    'music_playlist': const DomainDisplayConfig(cardType: 'music', titleTemplate: 'Playlist', icon: 'queue_music', colorHex: 0xFFE91E63),
  };
  ...
  Future<Map<String, dynamic>> _runAppleScript(String script) async {
    try {
      ...
      return {'success': false, 'error': 'AppleScript error: $e', 'domain': 'music'};
    }
  }
...
tell application "Music"
  ...
  Future<Map<String, dynamic>> _playPlaylist(Map<String, dynamic> data) async {
    ...
    return _runAppleScript('tell application "Music" to play playlist "$playlist"');
  }
}
