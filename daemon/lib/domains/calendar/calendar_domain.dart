...
class CalendarDomain extends TaskDomain {
  ...
  @override
  String get description => 'Schedule, list, and manage calendar events via Calendar.app';
  @override
  ...
  @override
  List<String> get taskTypes => ['calendar_add_event', 'calendar_list_events', 'calendar_delete_event'];
  ...
  List<DomainOllamaIntent> get ollamaIntents => [
    DomainOllamaIntent(
      ...
      parameters: {'title': 'event title', 'datetime_raw': 'date/time string'},
      examples: [
        OllamaExample(input: 'schedule meeting at 3pm tomorrow', intentJson: '{"intent": "calendar_add_event", "confidence": 0.95, "parameters": {"title": "meeting", "datetime_raw": "tomorrow 3pm"}}'),
        OllamaExample(input: 'add dentist appointment Friday 10am', intentJson: '{"intent": "calendar_add_event", "confidence": 0.95, "parameters": {"title": "dentist appointment", "datetime_raw": "Friday 10am"}}'),
      ],
    ),
    DomainOllamaIntent(
      ...
      examples: [
        OllamaExample(input: "what's on my calendar today", intentJson: '{"intent": "calendar_list_events", "confidence": 0.95, "parameters": {"date_raw": "today"}}'),
        OllamaExample(input: 'my schedule tomorrow', intentJson: '{"intent": "calendar_list_events", "confidence": 0.95, "parameters": {"date_raw": "tomorrow"}}'),
      ],
    ),
  ];
  ...
  Map<String, DomainDisplayConfig> get displayConfigs => {
    'calendar_add_event': const DomainDisplayConfig(cardType: 'calendar', titleTemplate: 'Event Created', icon: 'event', colorHex: 0xFF2196F3),
    'calendar_list_events': const DomainDisplayConfig(cardType: 'calendar', titleTemplate: 'Calendar', icon: 'calendar_today', colorHex: 0xFF2196F3),
    'calendar_delete_event': const DomainDisplayConfig(cardType: 'calendar', titleTemplate: 'Event Deleted', icon: 'event_busy', colorHex: 0xFF2196F3),
  };
  ...
  tell calendar "Home"
    ...
    try {
      ...
      return {
        ...
        'message': result.exitCode == 0 ? 'Created: $output' : (result.stderr as String).trim(),
