...
|------------|---------|-------------------|
| **Internet** | Connect to your computer's daemon service | Required |
...
- GitHub Repository: https://github.com/ai-dashboad/opencli
- Issue Tracker: https://github.com/ai-dashboad/opencli/issues
