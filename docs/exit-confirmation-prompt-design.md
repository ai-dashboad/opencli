...
This document describes how exit, shutdown, and interruption work in the Rust TUI (`opencli-rs/tui`).
It is intended for OpenCLI developers and OpenCLI itself when reasoning about future exit/shutdown
changes.
...
OpenCLI has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
