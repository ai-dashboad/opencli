...
export function GitHubIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M6.1 13.2c-2.8.8-2.8-1.5-3.9-1.8m7.8 3.2v-2.2c0-.6.1-.9-.3-1.2 1.9-.2 3.6-.9 3.6-4a3.1 3.1 0 0 0-.9-2.2 2.9 2.9 0 0 0-.1-2.2s-.7-.2-2.4.9a8.2 8.2 0 0 0-4.2 0C4 2.6 3.3 2.8 3.3 2.8a2.9 2.9 0 0 0-.1 2.2 3.1 3.1 0 0 0-.9 2.2c0 3.1 1.7 3.8 3.6 4-.3.3-.3.6-.3 1v2.4" />
    </Svg>
  );
}
