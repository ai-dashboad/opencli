...
use opencli_core::protocol::AgentStatus;
use opencli_core::protocol::AskForApproval;
use opencli_core::protocol::CollabAgentSpawnBeginEvent;
use opencli_core::protocol::CollabAgentSpawnEndEvent;
use opencli_core::protocol::CollabWaitingEndEvent;
...
use opencli_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use opencli_exec::exec_events::AgentMessageItem;
use opencli_exec::exec_events::CollabAgentState;
use opencli_exec::exec_events::CollabAgentStatus;
use opencli_exec::exec_events::CollabTool;
use opencli_exec::exec_events::CollabToolCallItem;
use opencli_exec::exec_events::CollabToolCallStatus;
use opencli_exec::exec_events::CommandExecutionItem;
use opencli_exec::exec_events::CommandExecutionStatus;
use opencli_exec::exec_events::ErrorItem;
use opencli_exec::exec_events::ItemCompletedEvent;
use opencli_exec::exec_events::ItemStartedEvent;
use opencli_exec::exec_events::ItemUpdatedEvent;
use opencli_exec::exec_events::McpToolCallItem;
use opencli_exec::exec_events::McpToolCallItemError;
use opencli_exec::exec_events::McpToolCallItemResult;
use opencli_exec::exec_events::McpToolCallStatus;
use opencli_exec::exec_events::PatchApplyStatus;
use opencli_exec::exec_events::PatchChangeKind;
use opencli_exec::exec_events::ReasoningItem;
use opencli_exec::exec_events::ThreadErrorEvent;
use opencli_exec::exec_events::ThreadEvent;
use opencli_exec::exec_events::ThreadItem;
use opencli_exec::exec_events::ThreadItemDetails;
use opencli_exec::exec_events::ThreadStartedEvent;
use opencli_exec::exec_events::TodoItem as ExecTodoItem;
use opencli_exec::exec_events::TodoListItem as ExecTodoListItem;
use opencli_exec::exec_events::TurnCompletedEvent;
use opencli_exec::exec_events::TurnFailedEvent;
use opencli_exec::exec_events::TurnStartedEvent;
use opencli_exec::exec_events::Usage;
use opencli_exec::exec_events::WebSearchItem;
...
use opencli_protocol::protocol::ExecCommandOutputDeltaEvent;
use opencli_protocol::protocol::ExecOutputStream;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        opencli_protocol::ThreadId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8").unwrap();
    ...
    let ev = event(
        ...
        EventMsg::SessionConfigured(SessionConfiguredEvent {
            ...
            forked_from_id: None,
            thread_name: None,
            model: "opencli-mini-latest".to_string(),
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TurnStarted(opencli_core::protocol::TurnStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TurnComplete(opencli_core::protocol::TurnCompleteEvent {
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(opencli_core::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(opencli_core::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = opencli_core::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = opencli_core::protocol::TokenUsageInfo {
    ...
    let token_count_event = event(
        "e1",
        EventMsg::TokenCount(opencli_core::protocol::TokenCountEvent {
            info: Some(info),
            rate_limits: None,
        }),
    );
