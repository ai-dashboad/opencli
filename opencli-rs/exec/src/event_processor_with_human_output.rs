use opencli_common::elapsed::format_duration;
use opencli_common::elapsed::format_elapsed;
...
use opencli_core::protocol::CollabAgentInteractionBeginEvent;
use opencli_core::protocol::CollabAgentInteractionEndEvent;
use opencli_core::protocol::CollabAgentSpawnBeginEvent;
use opencli_core::protocol::CollabAgentSpawnEndEvent;
use opencli_core::protocol::CollabCloseBeginEvent;
use opencli_core::protocol::CollabCloseEndEvent;
use opencli_core::protocol::CollabWaitingBeginEvent;
...
use opencli_core::web_search::web_search_detail;
use opencli_protocol::items::TurnItem;
use opencli_protocol::num_format::format_with_separators;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<opencli_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn process_event(&mut self, event: Event) -> OpenCLIStatus {
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    opencli_core::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    opencli_core::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    opencli_core::protocol::McpStartupStatus::Cancelled => "cancelled".to_string(),
                    opencli_core::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
            ...
            EventMsg::TurnComplete(TurnCompleteEvent { last_agent_message }) => {
                ...
                return OpenCLIStatus::InitiateShutdown;
            }
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "opencli".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "opencli session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return OpenCLIStatus::Shutdown,
...
fn format_receiver_list(ids: &[opencli_protocol::ThreadId]) -> String {
    if ids.is_empty() {
