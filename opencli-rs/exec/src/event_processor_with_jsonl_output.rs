...
use opencli_core::protocol;
use opencli_core::protocol::AgentStatus as CoreAgentStatus;
...
pub struct EventProcessorWithJsonOutput {
    ...
    last_total_token_usage: Option<opencli_core::protocol::TokenUsage>,
    ...
    pub fn collect_thread_events(&mut self, event: &protocol::Event) -> Vec<ThreadEvent> {
        match &event.msg {
            ...
            protocol::EventMsg::ItemCompleted(protocol::ItemCompletedEvent {
                item: opencli_protocol::items::TurnItem::Plan(item),
                ..
            }) => {
...
impl EventProcessor for EventProcessorWithJsonOutput {
    ...
    fn process_event(&mut self, event: protocol::Event) -> OpenCLIStatus {
        ...
        match msg {
            ...
            protocol::EventMsg::ShutdownComplete => OpenCLIStatus::Shutdown,
            _ => OpenCLIStatus::Running,
        }
    }
}
