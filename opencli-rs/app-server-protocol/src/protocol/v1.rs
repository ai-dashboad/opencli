...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [opencli_core::protocol::PatchApplyBeginEvent]
    /// and [opencli_core::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [opencli_core::protocol::ExecCommandBeginEvent]
    /// and [opencli_core::protocol::ExecCommandEndEvent].
    pub call_id: String,
