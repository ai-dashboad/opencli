...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by OpenCLI.
    ApiKey,
    /// ChatGPT OAuth managed by OpenCLI (tokens persisted and refreshed by OpenCLI).
    Chatgpt,
...
client_request_definitions! {
    ...
    /// List recorded OpenCLI conversations (rollouts) with optional pagination and search.
    ListConversations {
        params: v1::ListConversationsParams,
        response: v1::ListConversationsResponse,
    },
    /// Resume a recorded OpenCLI conversation from a rollout file.
    ResumeConversation {
        params: v1::ResumeConversationParams,
        response: v1::ResumeConversationResponse,
    },
    /// Fork a recorded OpenCLI conversation into a new session.
    ForkConversation {
...
/// Superset of [`opencli_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by OpenCLI Cloud.
