...
use opencli_core::auth::read_openai_api_key_from_env;
use opencli_login::DeviceCode;
...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use OpenCLI as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            .dim(),
            "".into(),
            "  OpenCLI can make mistakes".into(),
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  OpenCLI will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let widget = AuthModeWidget {
            ...
            opencli_home: opencli_home_path.clone(),
