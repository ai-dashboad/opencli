...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/openai/opencli/main/announcement_tip.toml";
...
/// Pick a random tooltip to show to the user when starting OpenCLI.
...
pub(crate) mod announcement {
    ...
    pub(crate) fn parse_announcement_tip_toml(text: &str) -> Option<String> {
        ...
        for raw in announcements {
            ...
            if tip.version_matches(OPENCLI_CLI_VERSION)
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for OpenCLI TUI.
...
[[announcements]]
content = "Welcome to OpenCLI! Check out the new onboarding flow."
