...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for OpenCLI",
            SlashCommand::Compact => "summarize conversation to prevent hitting the context limit",
            SlashCommand::Review => "review my current changes and find issues",
            SlashCommand::Rename => "rename the current thread",
            SlashCommand::Resume => "resume a saved chat",
            SlashCommand::Fork => "fork the current chat",
            // SlashCommand::Undo => "ask OpenCLI to undo a turn",
            SlashCommand::Quit | SlashCommand::Exit => "exit OpenCLI",
            ...
            SlashCommand::Loop => {
                "repeat a prompt on an interval (e.g. /loop 5m check the build; /loop stop)"
            }
            SlashCommand::Collab => "change collaboration mode (experimental)",
            SlashCommand::Agent => "switch the active agent thread",
            SlashCommand::Approvals => "choose what OpenCLI can do without approval",
            SlashCommand::Permissions => "choose what OpenCLI is allowed to do",
