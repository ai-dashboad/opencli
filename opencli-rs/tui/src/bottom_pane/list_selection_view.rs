...
mod tests {
    ...
    fn make_selection_view(subtitle: Option<&str>) -> ListSelectionView {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some("OpenCLI can read files".to_string()),
                is_current: true,
            ...
            SelectionItem {
                ...
                description: Some("OpenCLI can edit files".to_string()),
                is_current: false,
                dismiss_on_select: true,
                ..Default::default()
            },
    ...
    fn renders_blank_line_between_subtitle_and_items() {
        let view = make_selection_view(Some("Switch between OpenCLI approval presets"));
    ...
    fn width_changes_do_not_hide_rows() {
        ...
        let items = vec![
            ...
            SelectionItem {
                name: "gpt-4.1-opencli".to_string(),
                description: Some(
