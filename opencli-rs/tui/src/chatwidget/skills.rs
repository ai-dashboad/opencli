...
use opencli_core::connectors::connector_mention_slug;
use opencli_core::protocol::ListSkillsResponseEvent;
use opencli_core::protocol::SkillMetadata as ProtocolSkillMetadata;
use opencli_core::protocol::SkillsListEntry;
use opencli_core::skills::model::SkillDependencies;
use opencli_core::skills::model::SkillInterface;
use opencli_core::skills::model::SkillMetadata;
use opencli_core::skills::model::SkillToolDependency;
