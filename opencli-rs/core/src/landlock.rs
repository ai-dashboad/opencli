    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("opencli-linux-sandbox");
    spawn_child_async(
        opencli_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        command_cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `opencli-linux-sandbox`.
