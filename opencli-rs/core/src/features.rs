...
pub enum Feature {
    ...
    PowershellUtf8,
    /// Compress request bodies (zstd) when sending streaming requests to opencli-backend.
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW! Try shell snapshotting to make your OpenCLI faster. Enable in /experimental!",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Apps",
            menu_description: "Use a connected ChatGPT App using \"$\". Install Apps via /apps command. Restart OpenCLI after enabling.",
            announcement: "NEW: Use ChatGPT Apps (Connectors) in OpenCLI via $ mentions. Enable in /experimental and restart OpenCLI!",
        },
        default_enabled: false,
    },
    FeatureSpec {
