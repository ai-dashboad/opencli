...
use opencli_protocol::protocol::CollabAgentInteractionBeginEvent;
use opencli_protocol::protocol::CollabAgentInteractionEndEvent;
use opencli_protocol::protocol::CollabAgentSpawnBeginEvent;
use opencli_protocol::protocol::CollabAgentSpawnEndEvent;
use opencli_protocol::protocol::CollabCloseBeginEvent;
use opencli_protocol::protocol::CollabCloseEndEvent;
use opencli_protocol::protocol::CollabWaitingBeginEvent;
use opencli_protocol::protocol::CollabWaitingEndEvent;
    ...
    pub async fn handle(
        ...
        for id in &receiver_thread_ids {
            match session.services.agent_control.subscribe_status(*id).await {
                ...
                Err(OpenCLIErr::ThreadNotFound(_)) => {
...
fn collab_spawn_error(err: OpenCLIErr) -> FunctionCallError {
    match err {
...
fn collab_agent_error(agent_id: ThreadId, err: OpenCLIErr) -> FunctionCallError {
    match err {
        OpenCLIErr::ThreadNotFound(id) => {
...
fn build_agent_spawn_config(
    ...
    config.opencli_linux_sandbox_exe = turn.opencli_linux_sandbox_exe.clone();
...
mod tests {
    ...
    fn invocation(
        session: Arc<crate::opencli::Session>,
        turn: Arc<TurnContext>,
        tool_name: &str,
        payload: ToolPayload,
    ) -> ToolInvocation {
    ...
    async fn build_agent_spawn_config_uses_turn_context_values() {
        ...
        turn.opencli_linux_sandbox_exe = Some(PathBuf::from("/bin/echo"));
        ...
        expected.opencli_linux_sandbox_exe = turn.opencli_linux_sandbox_exe.clone();
