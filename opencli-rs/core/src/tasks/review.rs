...
use opencli_protocol::protocol::AgentMessageContentDeltaEvent;
use opencli_protocol::protocol::AgentMessageDeltaEvent;
use opencli_protocol::protocol::Event;
use opencli_protocol::protocol::EventMsg;
use opencli_protocol::protocol::ExitedReviewModeEvent;
...
use crate::opencli_delegate::run_opencli_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        let _ = session
            ...
            .services
            .otel_manager
            .counter("opencli.task.review", 1, &[]);

        // Start sub-opencli conversation and get the receiver for events.
