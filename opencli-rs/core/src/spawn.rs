...
///
/// 1. The process was spawned by OpenCLI as part of a shell tool call.
/// 2. SandboxPolicy.has_full_network_access() was false for the tool call.
///
/// We may try to have just one environment variable for all sandboxing
/// attributes, so this may change in the future.
pub const OPENCLI_SANDBOX_NETWORK_DISABLED_ENV_VAR: &str = "OPENCLI_SANDBOX_NETWORK_DISABLED";
...
pub const OPENCLI_SANDBOX_ENV_VAR: &str = "OPENCLI_SANDBOX";
...
/// `OPENCLI_SANDBOX_NETWORK_DISABLED_ENV_VAR` environment variable.
pub(crate) async fn spawn_child_async(
    ...
    if !sandbox_policy.has_full_network_access() {
        cmd.env(OPENCLI_SANDBOX_NETWORK_DISABLED_ENV_VAR, "1");
    }
    ...
    unsafe {
        ...
        cmd.pre_exec(move || {
            ...
            #[cfg(target_os = "linux")]
            {
                ...
                // current parent dies."
                opencli_utils_pty::process_group::set_parent_death_signal(parent_pid)?;
            }
            Ok(())
        });
    }
