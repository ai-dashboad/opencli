...
#[cfg(test)]
mod tests {
    use opencli_api::ResponsesApiRequest;
    use opencli_api::common::OpenAiVerbosity;
    use opencli_api::common::TextControls;
    ...
    fn serializes_text_schema_with_strict_format() {
        ...
        assert_eq!(
            format.get("name"),
            Some(&serde_json::Value::String("opencli_output_schema".into()))
        );
        assert_eq!(
            format.get("type"),
