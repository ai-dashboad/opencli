...
async fn send_track_skill_invocations(auth_manager: &AuthManager, job: TrackEventsJob) {
    // opencli: telemetry egress physically removed. Return before any event is
    // built or sent, so this function never contacts the network.
    ...
    let url = format!("{base_url}/opencli/analytics-events/events");
...
mod tests {
    ...
    fn normalize_path_for_skill_id_repo_scoped_uses_relative_path() {
        ...
        let skill_path = PathBuf::from("/repo/root/.opencli/skills/doc/SKILL.md");
        ...
        assert_eq!(path, ".opencli/skills/doc/SKILL.md");
    }

    #[test]
    fn normalize_path_for_skill_id_user_scoped_uses_absolute_path() {
        let skill_path = PathBuf::from("/Users/abc/.opencli/skills/doc/SKILL.md");
    ...
    fn normalize_path_for_skill_id_admin_scoped_uses_absolute_path() {
        let skill_path = PathBuf::from("/etc/opencli/skills/doc/SKILL.md");
    ...
    fn normalize_path_for_skill_id_repo_root_not_in_skill_path_uses_absolute_path() {
        let repo_root = PathBuf::from("/repo/root");
        let skill_path = PathBuf::from("/other/path/.opencli/skills/doc/SKILL.md");
