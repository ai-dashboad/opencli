...
pub const HIDE_GPT_5_1_OPENCLI_MAX_MIGRATION_PROMPT_CONFIG: &str =
    "hide_gpt-5.1-opencli-max_migration_prompt";
...
#[allow(dead_code)]
fn gpt_52_opencli_upgrade() -> ModelUpgrade {
    ModelUpgrade {
        id: "gpt-5.2-opencli".to_string(),
        reasoning_effort_mapping: None,
        migration_config_key: "gpt-5.2-opencli".to_string(),
        model_link: Some("https://openai.com/index/introducing-gpt-5-2-opencli".to_string()),
        upgrade_copy: Some(
            "OpenCLI is now powered by gpt-5.2-opencli, our latest frontier agentic coding model. It is smarter and faster than its predecessors and capable of long-running project-scale work."
                .to_string(),
        ),
        migration_markdown: Some(
            indoc! {r#"
                **OpenCLI just got an upgrade. Introducing {model_to}.**

                OpenCLI is now powered by gpt-5.2-opencli, our latest frontier agentic coding model. It is smarter and faster than its predecessors and capable of long-running project-scale work. Learn more about {model_to} at https://openai.com/index/introducing-gpt-5-2-opencli
