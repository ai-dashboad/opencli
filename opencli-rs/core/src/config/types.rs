...
pub use opencli_protocol::config_types::AltScreenMode;
pub use opencli_protocol::config_types::ModeKind;
pub use opencli_protocol::config_types::Personality;
pub use opencli_protocol::config_types::WebSearchMode;
...
pub struct McpServerConfig {
    ...
    /// When `false`, OpenCLI skips initializing this MCP server.
...
pub struct AnalyticsConfigToml {
    /// When `false`, disables analytics across OpenCLI product surfaces in this profile.
    pub enabled: Option<bool>,
}
...
pub struct FeedbackConfigToml {
    /// When `false`, disables the feedback flow across OpenCLI product surfaces.
    pub enabled: Option<bool>,
}
...
/// (primarily the OpenCLI IDE extension). NOTE: these are different from
...
impl From<SandboxWorkspaceWrite> for opencli_app_server_protocol::SandboxSettings {
