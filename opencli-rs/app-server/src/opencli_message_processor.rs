...
use opencli_app_server_protocol::AccountLoginCompletedNotification;
use opencli_app_server_protocol::AccountUpdatedNotification;
...
use opencli_app_server_protocol::AppsListParams;
use opencli_app_server_protocol::AppsListResponse;
use opencli_app_server_protocol::ArchiveConversationParams;
use opencli_app_server_protocol::ArchiveConversationResponse;
use opencli_app_server_protocol::AskForApproval;
use opencli_app_server_protocol::AuthMode;
use opencli_app_server_protocol::AuthStatusChangeNotification;
use opencli_app_server_protocol::CancelLoginAccountParams;
use opencli_app_server_protocol::CancelLoginAccountResponse;
use opencli_app_server_protocol::CancelLoginAccountStatus;
use opencli_app_server_protocol::CancelLoginChatGptResponse;
use opencli_app_server_protocol::ClientRequest;
use opencli_app_server_protocol::CollaborationModeListParams;
use opencli_app_server_protocol::CollaborationModeListResponse;
use opencli_app_server_protocol::CommandExecParams;
use opencli_app_server_protocol::ConversationGitInfo;
use opencli_app_server_protocol::ConversationSummary;
use opencli_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use opencli_app_server_protocol::ExecOneOffCommandResponse;
use opencli_app_server_protocol::FeedbackUploadParams;
use opencli_app_server_protocol::FeedbackUploadResponse;
use opencli_app_server_protocol::ForkConversationParams;
use opencli_app_server_protocol::ForkConversationResponse;
use opencli_app_server_protocol::FuzzyFileSearchParams;
use opencli_app_server_protocol::FuzzyFileSearchResponse;
use opencli_app_server_protocol::GetAccountParams;
use opencli_app_server_protocol::GetAccountRateLimitsResponse;
use opencli_app_server_protocol::GetAccountResponse;
use opencli_app_server_protocol::GetAuthStatusParams;
use opencli_app_server_protocol::GetAuthStatusResponse;
use opencli_app_server_protocol::GetConversationSummaryParams;
use opencli_app_server_protocol::GetConversationSummaryResponse;
use opencli_app_server_protocol::GetUserAgentResponse;
use opencli_app_server_protocol::GetUserSavedConfigResponse;
use opencli_app_server_protocol::GitDiffToRemoteResponse;
use opencli_app_server_protocol::GitInfo as ApiGitInfo;
use opencli_app_server_protocol::InputItem as WireInputItem;
use opencli_app_server_protocol::InterruptConversationParams;
use opencli_app_server_protocol::JSONRPCErrorError;
use opencli_app_server_protocol::ListConversationsParams;
use opencli_app_server_protocol::ListConversationsResponse;
use opencli_app_server_protocol::ListMcpServerStatusParams;
use opencli_app_server_protocol::ListMcpServerStatusResponse;
use opencli_app_server_protocol::LoginAccountParams;
use opencli_app_server_protocol::LoginAccountResponse;
use opencli_app_server_protocol::LoginApiKeyParams;
use opencli_app_server_protocol::LoginApiKeyResponse;
use opencli_app_server_protocol::LoginChatGptCompleteNotification;
use opencli_app_server_protocol::LoginChatGptResponse;
use opencli_app_server_protocol::LogoutAccountResponse;
use opencli_app_server_protocol::LogoutChatGptResponse;
use opencli_app_server_protocol::McpServerOauthLoginCompletedNotification;
use opencli_app_server_protocol::McpServerOauthLoginParams;
use opencli_app_server_protocol::McpServerOauthLoginResponse;
use opencli_app_server_protocol::McpServerRefreshResponse;
use opencli_app_server_protocol::McpServerStatus;
use opencli_app_server_protocol::ModelListParams;
use opencli_app_server_protocol::ModelListResponse;
use opencli_app_server_protocol::NewConversationParams;
use opencli_app_server_protocol::NewConversationResponse;
use opencli_app_server_protocol::RemoveConversationListenerParams;
use opencli_app_server_protocol::RemoveConversationSubscriptionResponse;
use opencli_app_server_protocol::RequestId;
use opencli_app_server_protocol::ResumeConversationParams;
use opencli_app_server_protocol::ResumeConversationResponse;
use opencli_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use opencli_app_server_protocol::ReviewStartParams;
use opencli_app_server_protocol::ReviewStartResponse;
use opencli_app_server_protocol::ReviewTarget as ApiReviewTarget;
use opencli_app_server_protocol::SandboxMode;
use opencli_app_server_protocol::SendUserMessageParams;
use opencli_app_server_protocol::SendUserMessageResponse;
use opencli_app_server_protocol::SendUserTurnParams;
use opencli_app_server_protocol::SendUserTurnResponse;
use opencli_app_server_protocol::ServerNotification;
use opencli_app_server_protocol::SessionConfiguredNotification;
use opencli_app_server_protocol::SetDefaultModelParams;
use opencli_app_server_protocol::SetDefaultModelResponse;
use opencli_app_server_protocol::SkillsConfigWriteParams;
use opencli_app_server_protocol::SkillsConfigWriteResponse;
use opencli_app_server_protocol::SkillsListParams;
use opencli_app_server_protocol::SkillsListResponse;
use opencli_app_server_protocol::Thread;
use opencli_app_server_protocol::ThreadArchiveParams;
use opencli_app_server_protocol::ThreadArchiveResponse;
use opencli_app_server_protocol::ThreadForkParams;
use opencli_app_server_protocol::ThreadForkResponse;
use opencli_app_server_protocol::ThreadItem;
use opencli_app_server_protocol::ThreadListParams;
use opencli_app_server_protocol::ThreadListResponse;
use opencli_app_server_protocol::ThreadLoadedListParams;
use opencli_app_server_protocol::ThreadLoadedListResponse;
use opencli_app_server_protocol::ThreadReadParams;
use opencli_app_server_protocol::ThreadReadResponse;
use opencli_app_server_protocol::ThreadResumeParams;
use opencli_app_server_protocol::ThreadResumeResponse;
use opencli_app_server_protocol::ThreadRollbackParams;
use opencli_app_server_protocol::ThreadSetNameParams;
use opencli_app_server_protocol::ThreadSetNameResponse;
use opencli_app_server_protocol::ThreadSortKey;
use opencli_app_server_protocol::ThreadSourceKind;
use opencli_app_server_protocol::ThreadStartParams;
use opencli_app_server_protocol::ThreadStartResponse;
use opencli_app_server_protocol::ThreadStartedNotification;
use opencli_app_server_protocol::ThreadUnarchiveParams;
use opencli_app_server_protocol::ThreadUnarchiveResponse;
use opencli_app_server_protocol::Turn;
use opencli_app_server_protocol::TurnError;
use opencli_app_server_protocol::TurnInterruptParams;
use opencli_app_server_protocol::TurnStartParams;
use opencli_app_server_protocol::TurnStartResponse;
use opencli_app_server_protocol::TurnStartedNotification;
use opencli_app_server_protocol::TurnStatus;
use opencli_app_server_protocol::UserInfoResponse;
...
use opencli_core::ThreadSortKey as CoreThreadSortKey;
use opencli_core::auth::CLIENT_ID;
use opencli_core::auth::login_with_api_key;
use opencli_core::auth::login_with_chatgpt_auth_tokens;
use opencli_core::config::Config;
use opencli_core::config::ConfigOverrides;
use opencli_core::config::ConfigService;
use opencli_core::config::edit::ConfigEdit;
...
use opencli_core::error::OpenCLIErr;
use opencli_core::exec::ExecParams;
use opencli_core::exec_env::create_env;
use opencli_core::features::Feature;
use opencli_core::find_archived_thread_path_by_id_str;
use opencli_core::find_thread_path_by_id_str;
use opencli_core::git_info::git_diff_to_remote;
use opencli_core::mcp::collect_mcp_snapshot;
use opencli_core::mcp::group_tools_by_server;
use opencli_core::parse_cursor;
use opencli_core::protocol::EventMsg;
use opencli_core::protocol::Op;
use opencli_core::protocol::ReviewDelivery as CoreReviewDelivery;
use opencli_core::protocol::ReviewRequest;
use opencli_core::protocol::ReviewTarget as CoreReviewTarget;
use opencli_core::protocol::SessionConfiguredEvent;
use opencli_core::read_head_for_summary;
use opencli_core::read_session_meta_line;
use opencli_core::rollout_date_parts;
use opencli_core::sandboxing::SandboxPermissions;
use opencli_core::state_db::get_state_db;
use opencli_core::token_data::parse_id_token;
use opencli_core::windows_sandbox::WindowsSandboxLevelExt;
use opencli_feedback::OpenCLIFeedback;
use opencli_login::ServerOptions as LoginServerOptions;
use opencli_login::ShutdownHandle;
use opencli_login::run_login_server;
use opencli_protocol::ThreadId;
use opencli_protocol::config_types::ForcedLoginMethod;
use opencli_protocol::config_types::Personality;
use opencli_protocol::config_types::WindowsSandboxLevel;
use opencli_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use opencli_protocol::items::TurnItem;
use opencli_protocol::models::ResponseItem;
use opencli_protocol::protocol::AgentStatus;
use opencli_protocol::protocol::GitInfo as CoreGitInfo;
use opencli_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
...
use opencli_rmcp_client::perform_oauth_login_return_url;
...
/// Handles JSON-RPC messages for OpenCLI threads (and legacy conversation APIs).
pub(crate) struct OpenCLIMessageProcessor {
...
pub(crate) struct OpenCLIMessageProcessorArgs {
...
impl OpenCLIMessageProcessor {
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<OpenCLIThread>), JSONRPCErrorError> {
    ...
    pub fn new(args: OpenCLIMessageProcessorArgs) -> Self {
        let OpenCLIMessageProcessorArgs {
            auth_manager,
            thread_manager,
            outgoing,
    ...
    async fn load_latest_config(&self) -> Result<Config, JSONRPCErrorError> {
        opencli_core::config::ConfigBuilder::default()
    ...
    fn review_request_from_target(
        ...
        let hint = opencli_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn login_api_key_v2(&mut self, request_id: RequestId, params: LoginApiKeyParams) {
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = opencli_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = opencli_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn login_chatgpt_auth_tokens(
        ...
        if let Err(err) =
            login_with_chatgpt_auth_tokens(&self.config.opencli_home, &id_token, &access_token)
        {
            let error = JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
    ...
    async fn get_account(&self, request_id: RequestId, params: GetAccountParams) {
        ...
        let account = match self.auth_manager.auth_cached() {
            Some(auth) => Some(match auth {
                OpenCLIAuth::ApiKey(_) => Account::ApiKey {},
                OpenCLIAuth::Chatgpt(_) | OpenCLIAuth::ChatgptAuthTokens(_) => {
    ...
    async fn fetch_account_rate_limits(&self) -> Result<CoreRateLimitSnapshot, JSONRPCErrorError> {
        let Some(auth) = self.auth_manager.auth().await else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "opencli account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch opencli rate limits: {err}"),
                data: None,
            })
    }

    async fn get_user_saved_config(&self, request_id: RequestId) {
        let service = ConfigService::new_with_defaults(self.config.opencli_home.clone());
    ...
    async fn set_default_model(&self, request_id: RequestId, params: SetDefaultModelParams) {
        ...
        match ConfigEditsBuilder::new(&self.config.opencli_home)
    ...
    async fn exec_one_off_command(&self, request_id: RequestId, params: CommandExecParams) {
        ...
        let opencli_linux_sandbox_exe = self.config.opencli_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        let req_id = request_id;
        let sandbox_cwd = self.config.cwd.clone();

        tokio::spawn(async move {
            match opencli_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &opencli_linux_sandbox_exe,
    ...
    async fn process_new_conversation(
        ...
        let typesafe_overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            opencli_linux_sandbox_exe: self.opencli_linux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<opencli_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(opencli_app_server_protocol::AskForApproval::to_core),
    ...
    async fn thread_set_name(&self, request_id: RequestId, params: ThreadSetNameParams) {
        ...
        let Some(name) = opencli_core::util::normalize_thread_name(&name) else {
    ...
    async fn thread_unarchive(&mut self, request_id: RequestId, params: ThreadUnarchiveParams) {
        ...
        let archived_folder = self
            .config
            .opencli_home
            .join(opencli_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.opencli_home.join(opencli_core::SESSIONS_SUBDIR);
    ...
    async fn thread_read(&mut self, request_id: RequestId, params: ThreadReadParams) {
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.opencli_home, &thread_uuid.to_string())
                .await
            {
            ...
            .await
        {
            ...
            Err(err) => {
                let (code, message) = match err {
                    OpenCLIErr::Io(_) | OpenCLIErr::Json(_) => (
                        INVALID_REQUEST_ERROR_CODE,
                        format!("failed to load rollout `{}`: {err}", rollout_path.display()),
                    ),
                    OpenCLIErr::InvalidRequest(message) => (INVALID_REQUEST_ERROR_CODE, message),
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.opencli_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match opencli_core::find_thread_path_by_id_str(
                    &self.config.opencli_home,
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.opencli_home.join(opencli_core::SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: RequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(opencli_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn skills_config_write(&self, request_id: RequestId, params: SkillsConfigWriteParams) {
        ...
        let result = ConfigEditsBuilder::new(&self.config.opencli_home)
            .with_edits(edits)
            .apply()
            .await;
    ...
    async fn start_inline_review(
        &self,
        request_id: &RequestId,
        parent_thread: Arc<OpenCLIThread>,
    ...
    async fn start_detached_review(
        ...
        let rollout_path =
            find_thread_path_by_id_str(&self.config.opencli_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
                    ...
                    event = conversation.next_event() => {
                        ...
                        outgoing_for_task
                            .send_notification(OutgoingNotification {
                                method: format!("opencli/event/{event_formatted}"),
...
fn skills_to_info(
    skills: &[opencli_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<opencli_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path);
            opencli_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    opencli_app_server_protocol::SkillInterface {
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    opencli_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| opencli_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn errors_to_info(
    errors: &[opencli_core::skills::SkillError],
) -> Vec<opencli_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| opencli_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(
    ...
    for tool in tools {
        ...
        if let Err(err) = opencli_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match opencli_core::parse_turn_item(&item) {
