...
use opencli_app_server_protocol::CommandAction as V2ParsedCommand;
use opencli_app_server_protocol::CommandExecutionApprovalDecision;
use opencli_app_server_protocol::CommandExecutionOutputDeltaNotification;
use opencli_app_server_protocol::CommandExecutionRequestApprovalParams;
use opencli_app_server_protocol::CommandExecutionRequestApprovalResponse;
use opencli_app_server_protocol::CommandExecutionStatus;
use opencli_app_server_protocol::ContextCompactedNotification;
use opencli_app_server_protocol::DeprecationNoticeNotification;
use opencli_app_server_protocol::DynamicToolCallParams;
use opencli_app_server_protocol::ErrorNotification;
use opencli_app_server_protocol::ExecCommandApprovalParams;
use opencli_app_server_protocol::ExecCommandApprovalResponse;
use opencli_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use opencli_app_server_protocol::FileChangeApprovalDecision;
use opencli_app_server_protocol::FileChangeOutputDeltaNotification;
...
use opencli_app_server_protocol::ReasoningSummaryPartAddedNotification;
use opencli_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use opencli_app_server_protocol::ReasoningTextDeltaNotification;
use opencli_app_server_protocol::ServerNotification;
use opencli_app_server_protocol::ServerRequestPayload;
use opencli_app_server_protocol::TerminalInteractionNotification;
use opencli_app_server_protocol::ThreadItem;
use opencli_app_server_protocol::ThreadNameUpdatedNotification;
use opencli_app_server_protocol::ThreadRollbackResponse;
use opencli_app_server_protocol::ThreadTokenUsage;
use opencli_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use opencli_app_server_protocol::ToolRequestUserInputOption;
use opencli_app_server_protocol::ToolRequestUserInputParams;
use opencli_app_server_protocol::ToolRequestUserInputQuestion;
use opencli_app_server_protocol::ToolRequestUserInputResponse;
use opencli_app_server_protocol::Turn;
use opencli_app_server_protocol::TurnCompletedNotification;
use opencli_app_server_protocol::TurnDiffUpdatedNotification;
use opencli_app_server_protocol::TurnError;
use opencli_app_server_protocol::TurnInterruptResponse;
...
use opencli_core::review_format::format_review_findings_block;
use opencli_core::review_prompts;
use opencli_protocol::ThreadId;
use opencli_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use opencli_protocol::plan_tool::UpdatePlanArgs;
use opencli_protocol::protocol::ReviewOutputEvent;
use opencli_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use opencli_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<OpenCLIThread>,
    ...
    match msg {
        ...
        EventMsg::ApplyPatchApprovalRequest(ApplyPatchApprovalRequestEvent {
            ...
            ApiVersion::V2 => {
                ...
                let patch_changes = file_changes_from_core(&changes);
        ...
        EventMsg::Error(ev) => {
            ...
            let opencli_error_info = ev.opencli_error_info.clone();
            ...
            if matches!(
                opencli_error_info,
                Some(CoreOpenCLIErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                opencli_error_info: ev.opencli_error_info.map(V2OpenCLIErrorInfo::from),
        ...
        EventMsg::PatchApplyBegin(patch_begin_event) => {
            ...
            if first_start {
                let item = ThreadItem::FileChange {
                    id: item_id.clone(),
                    changes: file_changes_from_core(&patch_begin_event.changes),
                    status: PatchApplyStatus::InProgress,
                };
                let notification = ItemStartedNotification {
                    thread_id: conversation_id.to_string(),
        ...
        EventMsg::PatchApplyEnd(patch_end_event) => {
            ...
            let changes = file_changes_from_core(&patch_end_event.changes);
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: opencli_protocol::models::ResponseItem,
    outgoing: &OutgoingMessageSender,
) {
...
async fn on_exec_approval_response(
    ...
    // Try to deserialize `value` and then make the appropriate call to `opencli`.
    let response =
...
mod tests {
    ...
    use opencli_core::protocol::RateLimitWindow;
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                opencli_error_info: Some(V2OpenCLIErrorInfo::InternalServerError),
                additional_details: None,
            },
            &turn_summary_store,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                opencli_error_info: Some(V2OpenCLIErrorInfo::Other),
                additional_details: None,
            },
            &turn_summary_store,
        )
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                opencli_error_info: Some(V2OpenCLIErrorInfo::BadRequest),
                additional_details: None,
            },
            &turn_summary_store,
        )
