...
- We leverage [`opencli_process_hardening`](https://github.com/openai/opencli/blob/main/opencli-rs/process-hardening/README.md) so `opencli-responses-api-proxy` is run with standard process-hardening techniques.
