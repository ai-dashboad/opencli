...
use opencli_app_server_protocol::UserInput;
use serde::Serialize;
...
impl AppServerClient {
    ...
    pub fn initialize(&mut self) -> Result<()> {
        ...
        let request = ClientRequest::Initialize {
            ...
            params: opencli_app_server_protocol::InitializeParams {
        ...
        let _parsed: opencli_app_server_protocol::InitializeResponse =
...
fn handle_server_request(
    ...
    let Ok(server_request) = opencli_app_server_protocol::ServerRequest::try_from(request) else {
        return Ok(());
    };

    match server_request {
        opencli_app_server_protocol::ServerRequest::CommandExecutionRequestApproval {
            request_id,
            ..
        } => {
            let response = opencli_app_server_protocol::CommandExecutionRequestApprovalResponse {
