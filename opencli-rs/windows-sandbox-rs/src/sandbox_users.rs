...
use opencli_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "OpenCLISandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "OpenCLI sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(opencli_home);
    ...
    let secrets_dir = sandbox_secrets_dir(opencli_home);
