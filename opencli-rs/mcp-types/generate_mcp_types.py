...
# ref: [#7417](https://github.com/ai-dashboad/opencli/pull/7417)
...
def define_struct(
    ...
    # Special-case: add OpenCLI-specific user_agent to Implementation
    if name == "Implementation":
        fields.append(
            StructField(
                ...
                '#[ts(optional)]',
                "This is an extra field that the OpenCLI MCP server sends as part of InitializeResult.",
            )
        )
