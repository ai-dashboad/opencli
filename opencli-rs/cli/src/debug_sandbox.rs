...
use opencli_core::landlock::spawn_command_under_linux_sandbox;
#[cfg(target_os = "macos")]
use opencli_core::seatbelt::spawn_command_under_seatbelt;
use opencli_core::spawn::StdioPolicy;
...
pub async fn run_command_under_seatbelt(
    ...
    _opencli_linux_sandbox_exe: Option<PathBuf>,
) -> anyhow::Result<()> {
...
async fn run_command_under_sandbox(
    ...
    if let SandboxType::Windows = sandbox_type {
        #[cfg(target_os = "windows")]
        {
            ...
            let base_dir = config.opencli_home.clone();
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let opencli_linux_sandbox_exe = config
                .opencli_linux_sandbox_exe
                .expect("opencli-linux-sandbox executable not found");
