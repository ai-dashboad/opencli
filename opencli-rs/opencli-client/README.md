...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any OpenCLI/OpenAI awareness.
...
- Consumed by higher-level crates like `opencli-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
