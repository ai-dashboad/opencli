use crate::default_client::OpenCLIHttpClient;
use crate::default_client::OpenCLIRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: OpenCLIHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<OpenCLIRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
